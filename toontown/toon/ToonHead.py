...
class ToonHead(Actor.Actor):
    ...
    def fromAvatar(self, avatar, forGui = 0):
        self.setupHead(avatar.style, forGui=forGui)
        self.generateHat(avatar.style, avatar.getHat())
        self.generateGlasses(avatar.style, avatar.getGlasses())
